...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { name: @type.name, typical_contract_name: @type.typical_contract_name } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { name: @type.name, typical_contract_name: @type.typical_contract_name } }
